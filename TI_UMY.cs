...
namespace ServiceRest_20180140013_AkbarSetiyoAdiPutro
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-TRP48B7;Initial Catalog=TI UMY;Persist Security Info=True;User ID=sa;Password=160500");
        ...
        {
            {
                ...
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-TRP48B7;Initial Catalog=TI UMY;Persist Security Info=True;User ID=sa;Password=160500");
